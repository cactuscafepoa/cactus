			...
			<section class="main-wrapper" style="padding:20px 0 20px 0px;">
				...
				<section class="contact__options" style="grid-template-columns: initial;max-width: 1040px;">
					<div class="contact__infos" style="padding:4px;font-size:14px;">
						<ul class="list-group">
							<li class="list-group-item d-flex justify-content-between align-items-center bg-secondary text-white" style="height:30px;">
							...
							<li class="list-group-item d-flex justify-content-between align-items-center" style="height:30px;">
								<span class="d-flex" style='width:20%;'>
									{{ $horario->dia_semana}}
								</span>
								<!--<span class="d-flex" style='width:15%;'>
