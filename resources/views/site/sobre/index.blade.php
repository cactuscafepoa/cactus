        ...
        <div class="main-wrapper split-content" style="justify-content:space-between;padding:0px;">
            ...
            <section class="about__content" style="padding:0px;">
                <section class="about__history">
                    ...
                    <p style="color:#FFFFFF;"><strong>Qualidade:</strong>  prezamos pela qualidade de nossos produtos, os quais fizemos com matérias primas selecionadas e com muito carinho.</p>
                    ...
                    <p style="color:#FFFFFF;"><strong>Distinção:</strong> acreditamops que a distinção no atendimento é a chave para prosperarmos, juntamento com toda a comunidade do bairro.</p>
                </section>
            </section>
